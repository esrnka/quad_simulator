...
%                       rad/sec.
%
%                  lB = 3x1 location of IMU accelerometer proof mass in
%                       the B frame, in meters.
%
%            Pk = 18x18 error covariance matrix for the estimator state
