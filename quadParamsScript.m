...
quadParams.Jq = 1e-9*[1756500 14600 125000;
                    14600 3572300 -9200;
                    125000 -9200 4713400];
% The circular-disk-equivalent area of the quad's body, in m^2
quadParams.Adisk = 0.01;
...
% a detailed aerodynamics model and handling of blade flexure.  These effects
% are included in the sim1/sim2/sim3.mat files given in the first lab.  You do
% not need to use these parameters for the Aerial Robotics course unless you'd
